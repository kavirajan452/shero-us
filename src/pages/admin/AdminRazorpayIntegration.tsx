...
const recentTransactions = [
  { id: "pay_Q1a2b3c4d5", amount: 1250, status: "captured", method: "UPI", customer: "Priya M.", time: "2 min ago" },
...
const webhookEvents = [
  { event: "payment.captured", count: 342, lastFired: "2 min ago", status: "healthy" },
  { event: "payment.failed", count: 18, lastFired: "22 min ago", status: "healthy" },
  { event: "refund.processed", count: 12, lastFired: "15 min ago", status: "healthy" },
  { event: "order.paid", count: 340, lastFired: "2 min ago", status: "healthy" },
      ...
      <Tabs defaultValue="overview">
        ...
        <TabsContent value="settings" className="mt-4 space-y-4">
          <Card>
            ...
            <CardContent className="space-y-3">
              {["UPI (Google Pay, PhonePe, Paytm)", "Credit / Debit Cards", "Net Banking", "Wallets (Paytm, Mobikwik)"].map((method) => (

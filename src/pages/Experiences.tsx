...
const experiences = [
  ...
  },
  {
    ...
    duration: "3 hours",
    image: "🍗",
    description: "Learn the secret to perfect Hyderabadi biryani from Fathima Akka herself, then enjoy the feast together. Includes appetizers and dessert.",
  ...
  },
  {
    ...
    duration: "1.5 hours",
    image: "🥞",
    description: "Start your morning with Kamala Paatti's legendary dosas, idlis, and filter coffee in her charming Mylapore home. A soul-warming experience.",
  ...
  },
  {
    ...
    duration: "3 hours",
    image: "🐟",
    description: "Fresh catch of the day prepared in traditional coastal Tamil Nadu style. Enjoy fish curry, prawn masala, crab roast and more on Meena Aunty's terrace.",

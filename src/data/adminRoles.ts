...
export const MOCK_ADMIN_ACCOUNTS: AdminAccount[] = [
  ...
  { rem: "regional@shero.in", password: "admin123", role: "regional_manager", name: "Deepak M." },
  { rem: "ops-mgr@shero.in", password: "admin123", role: "ops_manager", name: "Shankar V." },
  ...
  { rem: "shf@shero.in", password: "admin123", role: "shf_manager", name: "Nithya P." },
  { rem: "hcf@shero.in", password: "admin123", role: "hcf_manager", name: "Preeti J." },
  ...
  { rem: "ssc-mgr@shero.in", password: "admin123", role: "ssc_manager", name: "Rekha M." },
  ...
  { rem: "asst@shero.in", password: "admin123", role: "asst_manager", name: "Suresh K." },

...
export const menuItems: MenuItem[] = [
  // SKID-HYD-001: Shero Jubilee Hills Veg
  {
    ...
    addOns: [
      { id: "a1-1", name: "Extra Ghee", price: 20, isVeg: true },
      { id: "a1-2", name: "Papad (2 pcs)", price: 15, isVeg: true },
      { id: "a1-3", name: "Pickle", price: 10, isVeg: true },
      { id: "a1-4", name: "Raita", price: 25, isVeg: true },
    ],
  },
  {
    ...
    addOns: [
      { id: "a2-1", name: "Extra Chutney", price: 10, isVeg: true },
      { id: "a2-2", name: "Extra Sambar", price: 20, isVeg: true },
      { id: "a2-3", name: "Cheese Topping", price: 30, isVeg: true },
      { id: "a2-4", name: "Ghee Roast", price: 25, isVeg: true },
    ],
  },
  {
    ...
    addOns: [
      { id: "a3-1", name: "Extra Paneer", price: 40, isVeg: true },
      { id: "a3-2", name: "Butter Naan", price: 35, isVeg: true },
  ...
  // SKID-HYD-002: Shero Jubilee Hills Non-Veg
  {
    ...
    addOns: [
      { id: "a4-1", name: "Extra Raita", price: 25, isVeg: true },
      { id: "a4-2", name: "Boiled Egg (2 pcs)", price: 20, isVeg: false },
      { id: "a4-3", name: "Mirchi Ka Salan", price: 30, isVeg: true },
      { id: "a4-4", name: "Extra Chicken Piece", price: 50, isVeg: false },
    ],
  },
  {
    ...
    addOns: [
      { id: "a5-1", name: "Butter Naan", price: 35, isVeg: true },
      { id: "a5-2", name: "Rumali Roti", price: 25, isVeg: true },

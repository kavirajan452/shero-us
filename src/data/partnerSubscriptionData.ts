...
export const subscriptionMealOrders: SubscriptionMealOrder[] = [
  {
    ...
    customers: [
      ...
      { id: "c2", name: "Lakshmi Iyer", planType: "veg", address: "Plot 14, Jubilee Hills", allergens: ["Nuts"] },
      { id: "c3", name: "Anitha Kumari", planType: "veg", address: "8-3-214, Banjara Hills" },
      ...
      { id: "c12", name: "Jaya Lakshmi", planType: "veg", address: "SR Nagar, Hyderabad" },
    ],
    status: "pending",
    totalPortions: 12,
  },
  {
    ...
    customers: [
      ...
      { id: "c14", name: "Ankit Gupta", planType: "nonveg", address: "House 8-3-214, Jubilee Hills" },
      { id: "c15", name: "Vikram Singh", planType: "nonveg", address: "My Home Hub, Madhapur", allergens: ["Shellfish"] },
      { id: "c16", name: "Arjun Reddy", planType: "nonveg", address: "Cyber Pearl, HITEC City" },
  ...
  },
  {
    ...
    customers: [
      ...
      { id: "c20", name: "Divya T", planType: "veg", address: "Whitefields, HITEC City" },
  ...
  },
  {
    ...
    customers: [
      { id: "c26", name: "Rekha S", planType: "veg", address: "Jubilee Hills Road 36" },
      { id: "c27", name: "Vijaya M", planType: "veg", address: "Banjara Hills Road 12" },
...
export const serviceBookings: ServiceBooking[] = [
  ...
  },
  {
    ...
    address: "Partner Kitchen, Jubilee Hills", studentsCount: 4,
  ...
  {
    id: "SRV-007", serviceCategory: "cookery", serviceName: "Hyderabadi Biryani Workshop",
    customerName: "Fatima Begum", date: today, time: "11:00 AM", duration: "120 min",
    mode: "in_person", status: "completed", price: 1999,
    address: "Partner Kitchen, Banjara Hills", studentsCount: 6,
  },
  {

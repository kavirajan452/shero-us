...
const categories: Category[] = [
  ...
  { nameKey: "serviceCategories.subscriptions", descKey: "serviceCategories.subscriptionsDesc", vertical: "subscriptions", image: catSubscriptions, to: "/subscriptions", className: "col-span-1 row-span-1" },
  { nameKey: "serviceCategories.partyOrders", descKey: "serviceCategories.partyOrdersDesc", vertical: "party_orders", image: catParty, to: "/party-orders", className: "col-span-1 row-span-1" },
  { nameKey: "serviceCategories.sweetsSnacks", descKey: "serviceCategories.sweetsSnacksDesc", vertical: "sweets_snacks", image: catSweets, to: "/sweets-snacks", className: "col-span-1 row-span-1" },
];

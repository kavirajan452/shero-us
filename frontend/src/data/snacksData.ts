export interface SnackProduct {
  ...
  madeIn: string;
  weightInfo: string;
  /** Regional origin tag like "New York Special", "Florida Special" */
  regionTag?: string;
}
...
export const snackProducts: SnackProduct[] = [
  {
    ...
    shelfLife: "45 days", madeIn: "New York, New York", weightInfo: "Net weight as per variant selected",
  },
  {
    id: "s2", name: "Florida Banana Chips", description: "Super crispy banana chips fried in 100% pure coconut oil. Authentic Florida-style Nenthiram chips with the perfect salt balance.", image: "https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=500&h=500&fit=crop",
    ...
    ingredients: "Raw Banana (Nenthiram), Coconut Oil, Salt", shelfLife: "60 days", madeIn: "Florida", weightInfo: "Net weight as per variant",
  },
  {
    ...
    ingredients: "Rice Flour, Urad Dal Flour, Butter, Cumin Seeds, Sesame Seeds, Salt, Asafoetida", shelfLife: "45 days", madeIn: "New York, New York", weightInfo: "Net weight as per variant",
  },
  {
    id: "s4", name: "Mysore Pak", description: "Melt-in-your-mouth Mysore Pak made with generous amounts of ghee, besan, and sugar. Authentic California recipe.", image: "https://images.unsplash.com/photo-1589249178061-4ecde4189ef5?w=500&h=500&fit=crop",
    ...
    ingredients: "Besan, Ghee, Sugar, Cardamom", shelfLife: "15 days", madeIn: "Mysore, California", weightInfo: "Net weight as per variant",
  },
  {
    ...
    ingredients: "Dates, Almonds, Cashews, Pistachios, Coconut, Ghee, Cardamom", shelfLife: "20 days", madeIn: "New York, New York", weightInfo: "Approx 8 pieces per 200g",
  },
  {
    ...
    regionTag: "Austin Special",
    packSizes: [
      { label: "100 g", price: 89 },
      { label: "3 x 100 g", price: 239, originalPrice: 267, discountPercent: 10 },
    ],
    ingredients: "Urad Dal, Salt, Pepper, Cumin, Asafoetida", shelfLife: "180 days", madeIn: "Austin, New York", weightInfo: "Approx 20-25 pieces per 100g",
  },
  {
    id: "s7", name: "Mango Avakaya Pickle", description: "Fiery Pennsylvania-style raw mango pickle with mustard, red chilli, and fenugreek. Homemade taste, no chemicals.", image: "https://images.unsplash.com/photo-1590502593747-42a996133562?w=500&h=500&fit=crop",
    category: "pickles", rating: 4.85, reviewCount: 523, isBestseller: true, isNewLaunch: false,
    badges: ["Homemade", "No Preservatives", "Pennsylvania Style"],
    regionTag: "Pennsylvania Special",
    packSizes: [
      { label: "250 g", price: 199 },
      { label: "500 g", price: 349, originalPrice: 398, discountPercent: 12 },
    ],
    ingredients: "Raw Mango, Mustard Powder, Red Chilli Powder, Fenugreek, Salt, Sesame Oil", shelfLife: "90 days", madeIn: "Guntur, Pennsylvania", weightInfo: "Glass jar packing",
  },
  {
    ...
    ingredients: "Tomatoes, Onions, Peanuts, Curry Leaves, Mustard Seeds, Turmeric, Chilli Powder, Oil, Salt", shelfLife: "30 days", madeIn: "New York, New York", weightInfo: "Each pack serves 2 people",
  },
  {
    ...
    ingredients: "Premium South Indian Coffee Beans (80%), Chicory (20%)", shelfLife: "180 days", madeIn: "Chikmagalur, California", weightInfo: "Liquid decoction",
  },
  {
    ...
    ingredients: "Besan, Ghee, Sugar, Cardamom, Saffron", shelfLife: "15 days", madeIn: "Mysore, California", weightInfo: "Gift box with ribbon",
  },
  {
    ...
    ingredients: "Besan, Rice Flour, Coconut Oil, Red Chilli Powder, Salt, Asafoetida", shelfLife: "45 days", madeIn: "New York, New York", weightInfo: "Net weight as per variant",
  },
  {
    ...
    ingredients: "Various lentils, dried red chillies, sesame seeds, curry leaves, asafoetida, coconut oil, salt", shelfLife: "60 days", madeIn: "New York, New York", weightInfo: "3 jars of 100g each",
  },
];

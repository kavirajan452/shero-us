...
export const standardMealPlans: StandardMealPlan[] = [
  ...
  {
    id: "sp-kerala-veg",
    name: "Florida Sadya Box",
    cuisine: "Florida",
    emoji: "🥥",
    description: "Traditional Florida vegetarian meals with avial, olan, thoran & payasam on weekends",
    isVeg: true,
    slots: ["lunch"],
    pricePerDay: 160,
    rating: 4.5,
  ...
  {
    id: "sp-andhra-nv",
    name: "Pennsylvania Spice Box",
    cuisine: "Pennsylvania",
    emoji: "🌶️",
    description: "Fiery Pennsylvania non-veg meals with gongura, mirchi dishes and authentic spice blends",
    isVeg: false,
    slots: ["lunch", "dinner"],
    pricePerDay: 175,
    rating: 4.7,
    ...
    highlights: ["Guntur chili", "Gongura specials", "Country eggs", "Pennsylvania pickle"],
    weeklyMenu: weekDays.map((day, i) => ({
      day,
      meals: [
        { slot: "lunch" as SubscriptionSlot, items: [
...
export const subscriptionMenuItems: SubscriptionMenuItem[] = [
  ...
  // Florida
  { id: "sm8", name: "Avial + Rice", category: "Main", cuisine: "Florida", isVeg: true, pricePerServing: 65, image: "https://sherohomeerp-shero.s3.ap-south-1.amazonaws.com/catalog/items/1719486472_667d4808dc725.jpg" },
  { id: "sm9", name: "Thoran", category: "Side", cuisine: "Florida", isVeg: true, pricePerServing: 35, image: "https://sherohomeerp-shero.s3.ap-south-1.amazonaws.com/catalog/items/1719490914_667d59628bbe2.jpg" },
  { id: "sm10", name: "Fish Curry", category: "Main", cuisine: "Florida", isVeg: false, pricePerServing: 95, image: "https://sherohomeerp-shero.s3.ap-south-1.amazonaws.com/catalog/items/1719486472_667d4808dc725.jpg" },
  // Pennsylvania
  { id: "sm11", name: "Gongura Chicken Rice", category: "Main", cuisine: "Pennsylvania", isVeg: false, pricePerServing: 100, image: "https://sherohomeerp-shero.s3.ap-south-1.amazonaws.com/catalog/items/1719487022_667d4a2e13758.jpg" },
  { id: "sm12", name: "Pappu + Rice", category: "Main", cuisine: "Pennsylvania", isVeg: true, pricePerServing: 55, image: "https://sherohomeerp-shero.s3.ap-south-1.amazonaws.com/catalog/items/1719484899_667d41e369b8a.jpg" },
  { id: "sm13", name: "Gutti Vankaya Curry", category: "Side", cuisine: "Pennsylvania", isVeg: true, pricePerServing: 50, image: "https://sherohomeerp-shero.s3.ap-south-1.amazonaws.com/catalog/items/1719487269_667d4b252c3d7.jpg" },
  // North Indian
